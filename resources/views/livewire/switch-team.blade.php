...
<div class="min-w-0">
                ...
                <x-modal-input :title="__('common.new_team')">
                    <x-slot:content>
                        <button type="button" class="listbox-option w-full" @click="open = false">
                            ...
                            <span class="min-w-0 flex-1 text-left">{{ __('common.new_team_lower') }}</span>
                        </button>
                    </x-slot:content>
    ...
    <div class="hidden" :class="collapsed && 'lg:block'"
        ...
        <button @click="openTeamMenu($event)" type="button" title="{{ __('common.team_label') }}: {{ $currentTeam->name }}"
