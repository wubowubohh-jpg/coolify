...
class Select extends Component
{
    ...
    public function loadServices()
    {
        ...
        $gitBasedApplications = [
            [
                'id' => 'public',
                'name' => __('common.public_git_repository'),
                'description' => __('common.public_git_repository_card_description'),
                'documentation' => 'https://coolify.io/docs/applications/ci-cd',
                'logo' => asset('svgs/resources/public-repo.svg'),
            ],
            [
                'id' => 'private-deploy-key',
                'name' => __('common.private_git_repository_deploy_key'),
                'description' => __('common.private_git_repository_deploy_key_description'),
                'documentation' => 'https://coolify.io/docs/applications/ci-cd/github/deploy-key',
                'logo' => asset('svgs/resources/deploy-key.svg'),
            ],
            [
                'id' => 'private-gh-app',
                'name' => __('common.github_git_repository'),
                'description' => __('common.github_git_repository_description'),
            ...
            [
                ...
                'name' => __('common.gitlab_git_repository'),
                'description' => __('common.gitlab_git_repository_description'),
        ...
        $dockerBasedApplications = [
            [
                'id' => 'dockerfile',
                'name' => __('common.dockerfile'),
                'description' => __('common.dockerfile_card_description'),
            ...
            [
                ...
                'name' => __('common.docker_compose'),
                'description' => __('common.docker_compose_card_description'),
                'documentation' => 'https://coolify.io/docs/applications/build-packs/docker-compose',
                'logo' => asset('svgs/resources/docker-compose.svg'),
            ],
            [
                'id' => 'docker-image',
                'name' => __('common.docker_image'),
                'description' => __('common.docker_image_card_description'),
        ...
        $databases = [
            [
                'id' => 'postgresql',
                'name' => 'PostgreSQL',
                'description' => __('common.postgresql_card_description'),
                'logo' => asset('svgs/resources/postgres.svg'),
            ],
            [
                'id' => 'mysql',
                'name' => 'MySQL',
                'description' => __('common.mysql_card_description'),
            ...
            [
                'id' => 'mariadb',
                'name' => 'MariaDB',
                'description' => __('common.mariadb_card_description'),
                'logo' => asset('svgs/resources/mariadb.svg'),
            ],
            [
                'id' => 'redis',
                'name' => 'Redis',
                'description' => __('common.redis_card_description'),
                'logo' => asset('svgs/resources/redis.svg'),
            ],
            [
                'id' => 'keydb',
                'name' => 'KeyDB',
                'description' => __('common.keydb_card_description'),
            ...
            [
                'id' => 'dragonfly',
                'name' => 'Dragonfly',
                'description' => __('common.dragonfly_card_description'),
            ...
            [
                'id' => 'mongodb',
                'name' => 'MongoDB',
                'description' => __('common.mongodb_card_description'),
                'logo' => asset('svgs/resources/mongodb.svg'),
            ],
            [
                'id' => 'clickhouse',
                'name' => 'ClickHouse',
                'description' => __('common.clickhouse_card_description'),
